# CLAUDE.md — Korra Backend

> **This file's body is kept IDENTICAL to `.github/copilot-instructions.md`** (Copilot reads that one,
> Claude reads this one). When you change AI rules, update **both** files in this repo, and copy them to
